...
import { ListItemSecondaryAction, IconButton, ListItem, ListItemText, List, FormControl } from '@mui/material';
    ...
    const handleChange = (e, id) => {
        ...
        service
            ...
            .then(returnedStatus => {
                ...
                console.log(status)
                setStatus(list.map(todo => todo.id !== id ? todo : returnedStatus.status))
            })
            .catch(error => {
                console.log(error)
